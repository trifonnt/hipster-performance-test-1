...
@RestController
@RequestMapping("/api/hipster-test-01-kafka")
public class HipsterTest01KafkaResource {

    private final Logger log = LoggerFactory.getLogger(HipsterTest01KafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public HipsterTest01KafkaResource(KafkaProperties kafkaProperties) {
