package bg.aspar.test.config.timezone;

import bg.aspar.test.HipsterTest01App;
import bg.aspar.test.repository.timezone.DateTimeWrapper;
import bg.aspar.test.repository.timezone.DateTimeWrapperRepository;
