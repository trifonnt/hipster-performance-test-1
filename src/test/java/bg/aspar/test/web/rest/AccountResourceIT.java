package bg.aspar.test.web.rest;

import bg.aspar.test.HipsterTest01App;
import bg.aspar.test.config.Constants;
import bg.aspar.test.domain.User;
import bg.aspar.test.repository.AuthorityRepository;
import bg.aspar.test.repository.UserRepository;
import bg.aspar.test.security.AuthoritiesConstants;
import bg.aspar.test.service.UserService;
import bg.aspar.test.service.dto.PasswordChangeDTO;
import bg.aspar.test.service.dto.UserDTO;
import bg.aspar.test.web.rest.vm.KeyAndPasswordVM;
import bg.aspar.test.web.rest.vm.ManagedUserVM;
...
import static bg.aspar.test.web.rest.AccountResourceIT.TEST_USER_LOGIN;
...
@SpringBootTest(classes = HipsterTest01App.class)
