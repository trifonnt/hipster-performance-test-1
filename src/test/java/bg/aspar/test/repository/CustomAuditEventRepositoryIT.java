package bg.aspar.test.repository;

import bg.aspar.test.HipsterTest01App;

import bg.aspar.test.config.Constants;
import bg.aspar.test.config.audit.AuditEventConverter;
import bg.aspar.test.domain.PersistentAuditEvent;
...
import static bg.aspar.test.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
